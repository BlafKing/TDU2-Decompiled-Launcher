...
internal class Class7
{
	...
	private static string smethod_2(string string_0)
	{
		...
		string_0 = regex.Replace(string_0, "$1$3");
		return string_0;
	}
	...
	internal static int smethod_8(Stream stream_0)
	{
		...
		try
		{
			result = smethod_11(stream_0, "nul");
		}
	...
	protected internal static long smethod_12(Stream stream_0, int int_0)
	{
	...
	internal static DateTime smethod_14(DateTime dateTime_0)
	{
		if (dateTime_0.Kind == DateTimeKind.Utc)
		{
			return dateTime_0;
	...
	internal static DateTime smethod_15(int int_0)
	{
	...
	internal static int smethod_16(DateTime dateTime_0)
	{
	...
	public static void smethod_17(string string_0, out Stream stream_0, out string string_1)
	{
		for (int i = 0; i < 3; i++)
		{
			try
			{
				string_1 = Path.Combine(string_0, smethod_18());
	...
	internal static int smethod_19(Stream stream_0, byte[] byte_0, int int_0, int int_1, string string_0)
	{
		int result = 0;
		bool flag = false;
		int num = 0;
	...
	private static uint smethod_20(Exception exception_0)
	{
